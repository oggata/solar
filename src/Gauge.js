var Gauge = cc.Node.extend({
    ctor: function (width, height, color) {
        ...
        this.width = width;
        this.height = height;
        this.rectBase = cc.LayerColor.create(new cc.Color(0, 122, 255, 255), this.width, this.height);
        this.rectBase.setPosition(0, 0);
        this.addChild(this.rectBase, 1);

        var colorCode = new cc.Color(0, 122, 255, 255);
        this.rectBack = cc.LayerColor.create(colorCode, this.width - 2, this.height - 2);
